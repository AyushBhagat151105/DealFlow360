                    ...
                    <TableBody>
                      {displayQuotes.map((quote) => {
                        ...
                        return (
                          <TableRow
                            key={quote.id}
                            className={`cursor-pointer hover:bg-muted/30 ${quote.requiredApprovalLevel === "FINANCE" ? "border-l-2 border-l-destructive" : ""
                              }`}
                          ...
                          >
                            ...
                            <TableCell className="text-center">
                              <span
                                className={`text-xs font-mono font-bold ${risk > 10 ? "text-destructive" : risk > 0 ? "text-amber-500" : "text-emerald-500"
                                  }`}
                              >
                                {risk}
                              </span>
